...
import { useTheme } from '../components/useTheme.jsx';// ✅ FIXED
    ...
    <div className="min-h-[100dvh] flex flex-col bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white transition-colors duration-200 relative">
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4">
        <div className="max-w-2xl text-center space-y-8">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl transition-colors">
            {user ? (
              <div className="space-y-4">
                ...
                <button 
                  ...
                  className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-5 md:py-4 md:px-6 rounded-lg flex items-center justify-center gap-3 transition-all transform hover:scale-105"
                >
                  <span className="text-xl">Go to My Projects</span>
                </button>
              </div>
            ) : (
              <>
                <p className="text-lg mb-4 font-medium text-slate-700 dark:text-slate-200">
                  Get started by connecting your GitHub
                </p>
                <button 
                  onClick={handleLogin}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-slate-400 mt-12">
            <div className="p-4 bg-white dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm text-slate-600 dark:text-slate-400">
