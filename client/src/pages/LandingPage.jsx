...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white transition-colors duration-200">
      <style>{`
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4 pt-16">
        <div className="max-w-2xl text-center space-y-8">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">
          Group Project <span className="text-blue-600 dark:text-blue-500 inline-block" style={{ animation: 'subtle-float 3s ease-in-out infinite' }}>Tracker</span>
        </h1>
        <p className="text-xl text-slate-600 dark:text-slate-300">
          The ultimate tool for CSE students to track contributions, sync GitHub commits, and avoid last-minute panic.
        </p>
        
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl">
          ...
          <button 
            ...
            style={{ animation: 'gentle-pulse 2s infinite' }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-slate-500 dark:text-slate-400 mt-12">
          <div className="p-4 bg-white dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <footer className="py-6 text-center text-slate-500 text-sm border-t border-slate-200 dark:border-slate-800/50 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
